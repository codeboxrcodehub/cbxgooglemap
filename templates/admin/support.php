...
?>
<?php
$plugin_url = CBXGooglemapHelper::url_utmy('https://codeboxr.com/product/cbx-google-map-for-wordpress/');
$doc_url    = CBXGooglemapHelper::url_utmy('https://codeboxr.com/doc/cbxgooglemap-doc/');
        ...
        <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                ...
                                <li>[fixed] Sanitization and escaping improved</li>
                                <li>[improvement] PHP 8.2 compatible</li>
                                <li>[improvement] WordPress 6.4.3 compatible</li>
                                <li>[improvement] Frontend & Backend style improvement for settings and map</li>
                                <li>[improvement] Translation fixed</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="cbx-backend-card dashboard-changelog">
                    ...
                    <div class="content">
                        ...
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[Improvement] Backend UI improved.</li>
                                <li>[New] Hide leaflet branding yes/no globally from setting - default show as was before</li>
                                <li>[New] Custom slug for map details</li>
                                <li>[New] Custom slug for map archive</li>
                                <li>[New] Custom slug for map archive</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="col-6">
                        ...
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxgooglemap/reviews/#new-post"
                               target="_blank">
                                ...
                                <?php esc_html_e('Review & Rate CBX Map for Google Map & OpenStreetMap for WordPress', 'cbxgooglemap'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                ...
                <div class="cbx-backend-card dashboard-wp-plugin">
                    ...
                    <div class="content">
                        <?php
                        $items = CBXGooglemapHelper::codeboxr_news_feed();
