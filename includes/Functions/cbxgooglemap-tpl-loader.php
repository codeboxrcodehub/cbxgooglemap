 ...
 * @param string $default_path Default path. (default: '').
 */
function cbxgooglemap_get_template( $template_name, $args = [], $template_path = '', $default_path = '' ) {
 ...
 * @see   wc_get_template
 */
function cbxgooglemap_get_template_html( $template_name, $args = [], $template_path = '', $default_path = '' ) {
	ob_start();
