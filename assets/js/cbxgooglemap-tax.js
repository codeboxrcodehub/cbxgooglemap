(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $('.wrap').addClass('cbx-chota cbxgooglemap-page-wrapper cbxgooglemap-tax-wrapper');
        ...
        $tax_heading.text(cbxgooglemap_tax.tax_title_prefix+$tax_heading_title);
        ...
        $tax_wrapper.append(cbxgooglemap_tax.tax_new_setting);
        ...
        $('#screen-meta').addClass('cbx-chota cbxgooglemap-page-wrapper cbxgooglemap-tax-wrapper');
        $('#tag-search-input').attr('placeholder', cbxgooglemap_tax.placeholder.search);
